...
start_cluster() {
    ...
    echo "=========================================="
    echo "Iniciando Cluster de 3 Nós (FastAPI)..."
    echo "=========================================="

    # Garante que os datasets existem
    ...
    DATA_FILE_PATH=data/uber-raw-data-apr14.csv \
    ...
    DATA_FILE_PATH=data/uber-raw-data-may14.csv \
    ...
    DATA_FILE_PATH=data/uber-raw-data-jun14.csv \
    ...
    sleep 3
    echo "Servidor 01 (PID: $PID1) na porta 8001 -> Abril/2014"
    echo "Servidor 02 (PID: $PID2) na porta 8002 -> Maio/2014"
    echo "Servidor 03 (PID: $PID3) na porta 8003 -> Junho/2014"
    echo "=========================================="
    echo "Cluster iniciado! Logs salvos em $LOG_DIR/"
}
